...
class MainWeatherWindow extends React.Component {
  render() {
    ...
    return (
      <div className="main">
        <div className="inner-main">
          {title}
          <img
            src={this.props.data ? require(`../images/${this.props.data.icon}.svg`) : require('../images/01d.svg')}
            alt="sun"
            style={{
          ...
          >
            ...
            <p>
              Temperature: {this.props.data ? Math.round(this.props.data.temp - 273.15) : 0}°C
            </p>
